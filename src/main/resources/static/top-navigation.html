        ...
        <main class="main main--alt">
            ...
            <header class="header">
                ...
                <ul class="nav top-menu">
                    ...
                    <li class="nav-item"><a class="nav-link" href="index.html">Link</a></li>
                    <li class="nav-item dropdown">
                        <a class="nav-link" href="" data-toggle="dropdown">Dropdown</a>
                        <div class="dropdown-menu">
                            <a href="" class="dropdown-item">Pellentesque</a>
                            <a href="" class="dropdown-item">Vestibulum</a>
                            <a href="" class="dropdown-item">Quisque placerat</a>
                            <a href="" class="dropdown-item">Lorem ipsum</a>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link" href="" data-toggle="dropdown">Another Dropdown</a>
                        <div class="dropdown-menu">
                            <a href="" class="dropdown-item">Pellentesque</a>
                            <a href="" class="dropdown-item">Vestibulum</a>
                            <a href="" class="dropdown-item">Quisque placerat</a>
