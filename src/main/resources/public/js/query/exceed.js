        ...
        .ready(
                function() {
                    ...
                    $("#Plot").bind("plotselected", function(event, ranges) {
                        ...
                        // don't fire event on the overview to prevent eternal
                        // loop
                    ...
                    $('#timespan-table tbody')
                            .on(
                                    'click',
                                    'tr',
                                    function() {
                                        timespantable.$('tr.selected')
                                                .removeAttr('style');
                                        timespantable.$('tr.selected')
                                        ...
                                        var form = {
                                            'tableName' : $("#inputPatient")
                                                    .val(),
                                            'columnNames' : [ $("#inputColumn")
                                                    .val() ]
                                        };
                                        ...
                                        var openUrl = "http://localhost:3000/dashboard/db/templating?"
                                                + jQuery.param(params);
                                        window.open(openUrl);
