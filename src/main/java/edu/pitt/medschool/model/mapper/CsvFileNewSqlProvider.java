...
import edu.pitt.medschool.model.dto.CsvFileNewExample.Criteria;
import edu.pitt.medschool.model.dto.CsvFileNewExample.Criterion;
import edu.pitt.medschool.model.dto.CsvFileNewExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class CsvFileNewSqlProvider {
     ...
     * @mbg.generated
     */
    public String countByExample(CsvFileNewExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("csv_file_new");
     ...
     * @mbg.generated
     */
    public String deleteByExample(CsvFileNewExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("csv_file_new");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated
     */
    public String insertSelective(CsvFileNew record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("csv_file_new");
     ...
     * @mbg.generated
     */
    public String selectByExample(CsvFileNewExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        CsvFileNew record = (CsvFileNew) parameter.get("record");
        CsvFileNewExample example = (CsvFileNewExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("csv_file_new");
     ...
     * @mbg.generated
     */
    public String updateByPrimaryKeySelective(CsvFileNew record) {
        SQL sql = new SQL();
        sql.UPDATE("csv_file_new");
     ...
     * @mbg.generated
     */
    protected void applyWhere(SQL sql, CsvFileNewExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
