...
public class ExportSqlProvider {
     ...
     * @mbg.generated
     */
    public String insertSelective(Export record) {
        SQL sql = new SQL();
        ...
        if (record.getQueryJson() != null) {
            sql.VALUES("query_json", "#{queryJson,jdbcType=INTEGER}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        Export record = (Export) parameter.get("record");
        ...
        if (record.getQueryJson() != null) {
            sql.SET("query_json = #{record.queryJson,jdbcType=INTEGER}");
        }
     ...
     * @mbg.generated
     */
    public String updateByPrimaryKeySelective(Export record) {
        SQL sql = new SQL();
        sql.UPDATE("export");
        ...
        if (record.getQueryJson() != null) {
            sql.SET("query_json = #{queryJson,jdbcType=INTEGER}");
        }
