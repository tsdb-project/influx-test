...
public interface DownsampleGroupMapper {
     ...
     * @mbg.generated
     */
    @Insert({ "insert into downsample_group (query_id, label, ", "downsample, aggregation, ", "arType, create_time, ", "update_time, columns)",
            "values (#{queryId,jdbcType=INTEGER}, #{label,jdbcType=VARCHAR}, ", "#{downsample,jdbcType=VARCHAR}, #{aggregation,jdbcType=VARCHAR}, ",
            "#{artype,jdbcType=VARCHAR}, #{createTime,jdbcType=TIMESTAMP}, ", "#{updateTime,jdbcType=TIMESTAMP}, #{columns,jdbcType=LONGVARCHAR})" })
    ...
    @Results({ @Result(column = "id", property = "id", jdbcType = JdbcType.INTEGER, id = true), @Result(column = "query_id", property = "queryId", jdbcType = JdbcType.INTEGER),
            @Result(column = "label", property = "label", jdbcType = JdbcType.VARCHAR), @Result(column = "downsample", property = "downsample", jdbcType = JdbcType.VARCHAR),
            @Result(column = "aggregation", property = "aggregation", jdbcType = JdbcType.VARCHAR), @Result(column = "arType", property = "artype", jdbcType = JdbcType.VARCHAR),
     ...
     * @mbg.generated
     */
    @Select({ "select", "id, query_id, label, downsample, aggregation, arType, create_time, update_time, ", "columns", "from downsample_group", "where id = #{id,jdbcType=INTEGER}" })
    @Results({ @Result(column = "id", property = "id", jdbcType = JdbcType.INTEGER, id = true), @Result(column = "query_id", property = "queryId", jdbcType = JdbcType.INTEGER),
            @Result(column = "label", property = "label", jdbcType = JdbcType.VARCHAR), @Result(column = "downsample", property = "downsample", jdbcType = JdbcType.VARCHAR),
            @Result(column = "aggregation", property = "aggregation", jdbcType = JdbcType.VARCHAR), @Result(column = "arType", property = "artype", jdbcType = JdbcType.VARCHAR),
            @Result(column = "create_time", property = "createTime", jdbcType = JdbcType.TIMESTAMP), @Result(column = "update_time", property = "updateTime", jdbcType = JdbcType.TIMESTAMP),
     ...
     * @mbg.generated
     */
    @Update({ "update downsample_group", "set query_id = #{queryId,jdbcType=INTEGER},", "label = #{label,jdbcType=VARCHAR},", "downsample = #{downsample,jdbcType=VARCHAR},",
            "aggregation = #{aggregation,jdbcType=VARCHAR},", "arType = #{artype,jdbcType=VARCHAR},", "create_time = #{createTime,jdbcType=TIMESTAMP},",
            "update_time = #{updateTime,jdbcType=TIMESTAMP},", "columns = #{columns,jdbcType=LONGVARCHAR}", "where id = #{id,jdbcType=INTEGER}" })
