...
public interface DownsampleGroupMapper {
     ...
     * @mbg.generated
     */
    @Insert({ "insert into downsample_group (query_id, label, ", "downsample, aggregation, ", "create_time, update_time, ", "deleted, columns)",
            "values (#{queryId,jdbcType=INTEGER}, #{label,jdbcType=VARCHAR}, ", "#{downsample,jdbcType=VARCHAR}, #{aggregation,jdbcType=VARCHAR}, ",
            "#{createTime,jdbcType=TIMESTAMP}, #{updateTime,jdbcType=TIMESTAMP}, ", "#{deleted,jdbcType=BIT}, #{columns,jdbcType=LONGVARCHAR})" })
     ...
     * @mbg.generated
     */
    @Select({ "select", "id, query_id, label, downsample, aggregation, create_time, update_time, deleted, ", "columns", "from downsample_group",
    ...
    @Update({ "update downsample_group", "set query_id = #{queryId,jdbcType=INTEGER},", "label = #{label,jdbcType=VARCHAR},",
            ...
            "deleted = #{deleted,jdbcType=BIT},", "columns = #{columns,jdbcType=LONGVARCHAR}", "where id = #{id,jdbcType=INTEGER}" })
