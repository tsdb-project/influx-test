...
public interface DownsampleGroupMapper {
     ...
     * @mbg.generated
     */
    @Insert({ "insert into downsample_group (query_id, downsample, ", "aggregation, create_time, ", "update_time)", "values (#{queryId,jdbcType=INTEGER}, #{downsample,jdbcType=VARCHAR}, ", "#{aggregation,jdbcType=VARCHAR}, #{createTime,jdbcType=TIMESTAMP}, ", "#{updateTime,jdbcType=TIMESTAMP})" })
    ...
    @Results({ @Result(column = "id", property = "id", jdbcType = JdbcType.INTEGER, id = true), @Result(column = "query_id", property = "queryId", jdbcType = JdbcType.INTEGER), @Result(column = "downsample", property = "downsample", jdbcType = JdbcType.VARCHAR), @Result(column = "aggregation", property = "aggregation", jdbcType = JdbcType.VARCHAR), @Result(column = "create_time", property = "createTime", jdbcType = JdbcType.TIMESTAMP),
     ...
     * @mbg.generated
     */
    @Update({ "update downsample_group", "set query_id = #{queryId,jdbcType=INTEGER},", "downsample = #{downsample,jdbcType=VARCHAR},", "aggregation = #{aggregation,jdbcType=VARCHAR},", "create_time = #{createTime,jdbcType=TIMESTAMP},", "update_time = #{updateTime,jdbcType=TIMESTAMP}", "where id = #{id,jdbcType=INTEGER}" })
