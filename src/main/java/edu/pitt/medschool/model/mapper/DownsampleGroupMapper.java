...
public interface DownsampleGroupMapper {
     ...
     */
    @Insert({
        "insert into downsample_group (query_id, label, ",
    ...
    @Select({
        "select",
        "id, query_id, label, downsample, aggregation, create_time, update_time, columns",
        "from downsample_group",
        "where id = #{id,jdbcType=INTEGER}"
    })
    @Results({
        @Result(column="id", property="id", jdbcType=JdbcType.INTEGER, id=true),
     ...
     */
    @Update({
        "update downsample_group",
        "set query_id = #{queryId,jdbcType=INTEGER},",
          "label = #{label,jdbcType=VARCHAR},",
          "downsample = #{downsample,jdbcType=VARCHAR},",
          "aggregation = #{aggregation,jdbcType=VARCHAR},",
