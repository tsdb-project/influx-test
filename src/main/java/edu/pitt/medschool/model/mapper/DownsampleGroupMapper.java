...
public interface DownsampleGroupMapper {
     ...
     * @mbg.generated
     */
    @Insert({ "insert into downsample_group (query_id, label, ", "downsample, aggregation, ", "columns, create_time, ", "update_time)",
            "values (#{queryId,jdbcType=INTEGER}, #{label,jdbcType=VARCHAR}, ", "#{downsample,jdbcType=VARCHAR}, #{aggregation,jdbcType=VARCHAR}, ",
            "#{columns,jdbcType=CHAR}, #{createTime,jdbcType=TIMESTAMP}, ", "#{updateTime,jdbcType=TIMESTAMP})" })
    ...
    @Results({ @Result(column = "id", property = "id", jdbcType = JdbcType.INTEGER, id = true), @Result(column = "query_id", property = "queryId", jdbcType = JdbcType.INTEGER),
            ...
            @Result(column = "aggregation", property = "aggregation", jdbcType = JdbcType.VARCHAR), @Result(column = "columns", property = "columns", jdbcType = JdbcType.CHAR),
     ...
     * @mbg.generated
     */
    @Select({ "select", "id, query_id, label, downsample, aggregation, columns, create_time, update_time", "from downsample_group", "where id = #{id,jdbcType=INTEGER}" })
    @Results({ @Result(column = "id", property = "id", jdbcType = JdbcType.INTEGER, id = true), @Result(column = "query_id", property = "queryId", jdbcType = JdbcType.INTEGER),
            @Result(column = "label", property = "label", jdbcType = JdbcType.VARCHAR), @Result(column = "downsample", property = "downsample", jdbcType = JdbcType.VARCHAR),
            @Result(column = "aggregation", property = "aggregation", jdbcType = JdbcType.VARCHAR), @Result(column = "columns", property = "columns", jdbcType = JdbcType.CHAR),
            @Result(column = "create_time", property = "createTime", jdbcType = JdbcType.TIMESTAMP),
    ...
    @Update({ "update downsample_group", "set query_id = #{queryId,jdbcType=INTEGER},", "label = #{label,jdbcType=VARCHAR},", "downsample = #{downsample,jdbcType=VARCHAR},",
            "aggregation = #{aggregation,jdbcType=VARCHAR},", "columns = #{columns,jdbcType=CHAR},", "create_time = #{createTime,jdbcType=TIMESTAMP},",
