...
public interface DownsampleMetaMapper {
     ...
     * @mbg.generated
     */
    @Insert({ "insert into downsample_meta (id, query_id, ", "key, value, create_time, ", "update_time)", "values (#{id,jdbcType=INTEGER}, #{queryId,jdbcType=INTEGER}, ", "#{key,jdbcType=VARCHAR}, #{value,jdbcType=VARCHAR}, #{createTime,jdbcType=TIMESTAMP}, ", "#{updateTime,jdbcType=TIMESTAMP})" })
