...
public interface DownsampleMetaMapper {
     ...
     * @mbg.generated
     */
    @Insert({ "insert into downsample_meta (query_id, key, ", "value, create_time, ", "update_time)",
            "values (#{queryId,jdbcType=INTEGER}, #{key,jdbcType=VARCHAR}, ", "#{value,jdbcType=VARCHAR}, #{createTime,jdbcType=TIMESTAMP}, ",
     ...
     * @mbg.generated
     */
    @Update({ "update downsample_meta", "set query_id = #{queryId,jdbcType=INTEGER},", "key = #{key,jdbcType=VARCHAR},",
            "value = #{value,jdbcType=VARCHAR},", "create_time = #{createTime,jdbcType=TIMESTAMP},", "update_time = #{updateTime,jdbcType=TIMESTAMP}",
