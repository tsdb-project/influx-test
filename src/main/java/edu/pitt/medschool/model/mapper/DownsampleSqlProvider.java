...
public class DownsampleSqlProvider {
    ...
    public String insertSelective(Downsample record) {
        ...
        if (record.getMinTotalBinThreshold() != null) {
            sql.VALUES("min_total_bin_threshold", "#{minTotalBinThreshold,jdbcType=INTEGER}");
        }
        ...
        if (record.getPatientlist() != null) {
            sql.VALUES("patientList", "#{patientlist,jdbcType=LONGVARCHAR}");
        }
        return sql.toString();
    }
     ...
     * @mbg.generated
     */
    public String selectByExampleWithBLOBs(DownsampleExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getPatientlist() != null) {
            sql.SET("patientList = #{record.patientlist,jdbcType=LONGVARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(Downsample record) {
        ...
        if (record.getMinTotalBinThreshold() != null) {
            sql.SET("min_total_bin_threshold = #{minTotalBinThreshold,jdbcType=INTEGER}");
        }
        if (record.getMinEveryBinThershold() != null) {
        ...
        if (record.getPatientlist() != null) {
            sql.SET("patientList = #{patientlist,jdbcType=LONGVARCHAR}");
        }
