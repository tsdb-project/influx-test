...
import edu.pitt.medschool.model.dto.DownsampleGroupColumnExample.Criteria;
import edu.pitt.medschool.model.dto.DownsampleGroupColumnExample.Criterion;
import edu.pitt.medschool.model.dto.DownsampleGroupColumnExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class DownsampleGroupColumnSqlProvider {

    /**
     * This method was generated by MyBatis Generator. This method corresponds to the database table downsample_group_column
     * @mbg.generated
     */
    public String countByExample(DownsampleGroupColumnExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("downsample_group_column");
     ...
     * @mbg.generated
     */
    public String deleteByExample(DownsampleGroupColumnExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("downsample_group_column");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated
     */
    public String selectByExample(DownsampleGroupColumnExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        DownsampleGroupColumn record = (DownsampleGroupColumn) parameter.get("record");
     ...
     * @mbg.generated
     */
    public String updateByPrimaryKeySelective(DownsampleGroupColumn record) {
        SQL sql = new SQL();
        sql.UPDATE("downsample_group_column");
        if (record.getQueryGroupId() != null) {
     ...
     * @mbg.generated
     */
    protected void applyWhere(SQL sql, DownsampleGroupColumnExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
        String parmPhrase1;
