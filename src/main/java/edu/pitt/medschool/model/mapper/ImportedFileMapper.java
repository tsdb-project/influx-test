...
public interface ImportedFileMapper {
     ...
     */
    @Insert({
        "insert into imported_file (id, filepath, ",
        "filename, PID, isAr, ",
        "timestamp)",
        "values (#{id,jdbcType=INTEGER}, #{filepath,jdbcType=VARCHAR}, ",
        "#{filename,jdbcType=VARCHAR}, #{pid,jdbcType=VARCHAR}, #{isar,jdbcType=CHAR}, ",
    ...
    @Results({
        ...
        @Result(column="isAr", property="isar", jdbcType=JdbcType.CHAR),
    ...
    @Select({
        "select",
        "id, filepath, filename, PID, isAr, timestamp",
        "from imported_file",
        "where id = #{id,jdbcType=INTEGER}"
    })
    @Results({
