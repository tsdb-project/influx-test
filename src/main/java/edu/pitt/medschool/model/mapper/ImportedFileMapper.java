...
public interface ImportedFileMapper {
     ...
     * @mbg.generated
     */
    @Delete({ "delete from imported_file", "where id = #{id,jdbcType=INTEGER}" })
    ...
    @Insert({ "insert into imported_file (id, filepath, ", "filename, filelines, ", "filesize, PID, isAr, ",
            "timestamp, uuid, ", "deleted, delete_time)", "values (#{id,jdbcType=INTEGER}, #{filepath,jdbcType=VARCHAR}, ",
            "#{filename,jdbcType=VARCHAR}, #{filelines,jdbcType=INTEGER}, ",
            "#{filesize,jdbcType=BIGINT}, #{pid,jdbcType=VARCHAR}, #{isar,jdbcType=BIT}, ",
            "#{timestamp,jdbcType=TIMESTAMP}, #{uuid,jdbcType=VARCHAR}, ",
     ...
     * @mbg.generated
     */
    @Select({ "select", "id, filepath, filename, filelines, filesize, PID, isAr, timestamp, uuid, deleted, ", "delete_time",
            "from imported_file", "where id = #{id,jdbcType=INTEGER}" })
    @Results({ @Result(column = "id", property = "id", jdbcType = JdbcType.INTEGER, id = true),
            @Result(column = "filepath", property = "filepath", jdbcType = JdbcType.VARCHAR),
            @Result(column = "filename", property = "filename", jdbcType = JdbcType.VARCHAR),
            @Result(column = "filelines", property = "filelines", jdbcType = JdbcType.INTEGER),
            ...
            @Result(column = "deleted", property = "deleted", jdbcType = JdbcType.BIT),
            @Result(column = "delete_time", property = "deleteTime", jdbcType = JdbcType.TIMESTAMP) })
    ImportedFile selectByPrimaryKey(Integer id);
     ...
     * @mbg.generated
     */
    @UpdateProvider(type = ImportedFileSqlProvider.class, method = "updateByPrimaryKeySelective")
    int updateByPrimaryKeySelective(ImportedFile record);
     ...
     * @mbg.generated
     */
    @Update({ "update imported_file", "set filepath = #{filepath,jdbcType=VARCHAR},",
            "filename = #{filename,jdbcType=VARCHAR},", "filelines = #{filelines,jdbcType=INTEGER},",
            "filesize = #{filesize,jdbcType=BIGINT},", "PID = #{pid,jdbcType=VARCHAR},", "isAr = #{isar,jdbcType=BIT},",
            "timestamp = #{timestamp,jdbcType=TIMESTAMP},", "uuid = #{uuid,jdbcType=VARCHAR},",
            "deleted = #{deleted,jdbcType=BIT},", "delete_time = #{deleteTime,jdbcType=TIMESTAMP}",
            "where id = #{id,jdbcType=INTEGER}" })
    int updateByPrimaryKey(ImportedFile record);
