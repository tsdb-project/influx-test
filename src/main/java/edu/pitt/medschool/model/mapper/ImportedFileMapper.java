...
public interface ImportedFileMapper {
     ...
     * This method was generated by MyBatis Generator. This method corresponds to the database table imported_file
     * @mbg.generated
     */@Insert({"insert into imported_file (id, filepath, ","filename, filelines, ","filesize, PID, isAr, ","timestamp)","values (#{id,jdbcType=INTEGER}, #{filepath,jdbcType=VARCHAR}, ","#{filename,jdbcType=VARCHAR}, #{filelines,jdbcType=INTEGER}, ","#{filesize,jdbcType=BIGINT}, #{pid,jdbcType=VARCHAR}, #{isar,jdbcType=BIT}, ","#{timestamp,jdbcType=TIMESTAMP})"}) int insert(ImportedFile record);
     ...
     * This method was generated by MyBatis Generator. This method corresponds to the database table imported_file
     * @mbg.generated
     */@Select({"select","id, filepath, filename, filelines, filesize, PID, isAr, timestamp","from imported_file","where id = #{id,jdbcType=INTEGER}"}) @Results({@Result(column="id", property="id", jdbcType=JdbcType.INTEGER, id=true),@Result(column="filepath", property="filepath", jdbcType=JdbcType.VARCHAR),@Result(column="filename", property="filename", jdbcType=JdbcType.VARCHAR),@Result(column="filelines", property="filelines", jdbcType=JdbcType.INTEGER),@Result(column="filesize", property="filesize", jdbcType=JdbcType.BIGINT),@Result(column="PID", property="pid", jdbcType=JdbcType.VARCHAR),@Result(column="isAr", property="isar", jdbcType=JdbcType.BIT),@Result(column="timestamp", property="timestamp", jdbcType=JdbcType.TIMESTAMP)}) ImportedFile selectByPrimaryKey(Integer id);
     ...
     * This method was generated by MyBatis Generator. This method corresponds to the database table imported_file
     * @mbg.generated
     */@Update({"update imported_file","set filepath = #{filepath,jdbcType=VARCHAR},","filename = #{filename,jdbcType=VARCHAR},","filelines = #{filelines,jdbcType=INTEGER},","filesize = #{filesize,jdbcType=BIGINT},","PID = #{pid,jdbcType=VARCHAR},","isAr = #{isar,jdbcType=BIT},","timestamp = #{timestamp,jdbcType=TIMESTAMP}","where id = #{id,jdbcType=INTEGER}"}) int updateByPrimaryKey(ImportedFile record);
}