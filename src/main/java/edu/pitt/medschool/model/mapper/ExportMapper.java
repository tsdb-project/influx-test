...
public interface ExportMapper {
     ...
     * @mbg.generated
     */
    @Insert({ "insert into export (query_id, ar, ", "layout, create_time, ", "update_time, machine, ", "db_version, patient_list, ", "query_json)",
            "values (#{queryId,jdbcType=INTEGER}, #{ar,jdbcType=BIT}, ", "#{layout,jdbcType=BIT}, #{createTime,jdbcType=TIMESTAMP}, ",
            "#{updateTime,jdbcType=TIMESTAMP}, #{machine,jdbcType=VARCHAR}, ", "#{dbVersion,jdbcType=VARCHAR}, #{patientList,jdbcType=LONGVARCHAR}, ",
     ...
     * @mbg.generated
     */
    @Select({ "select", "id, query_id, ar, layout, create_time, update_time, machine, db_version, patient_list, ", "query_json", "from export",
     ...
     * @mbg.generated
     */
    @Update({ "update export", "set query_id = #{queryId,jdbcType=INTEGER},", "ar = #{ar,jdbcType=BIT},", "layout = #{layout,jdbcType=BIT},",
            "create_time = #{createTime,jdbcType=TIMESTAMP},", "update_time = #{updateTime,jdbcType=TIMESTAMP},",
            "machine = #{machine,jdbcType=VARCHAR},", "db_version = #{dbVersion,jdbcType=VARCHAR},",
            "patient_list = #{patientList,jdbcType=LONGVARCHAR},", "query_json = #{queryJson,jdbcType=LONGVARCHAR}",
            "where id = #{id,jdbcType=INTEGER}" })
    ...
    @Update({ "update export", "set query_id = #{queryId,jdbcType=INTEGER},", "ar = #{ar,jdbcType=BIT},", "layout = #{layout,jdbcType=BIT},",
            "create_time = #{createTime,jdbcType=TIMESTAMP},", "update_time = #{updateTime,jdbcType=TIMESTAMP},",
            "machine = #{machine,jdbcType=VARCHAR},", "db_version = #{dbVersion,jdbcType=VARCHAR}", "where id = #{id,jdbcType=INTEGER}" })
