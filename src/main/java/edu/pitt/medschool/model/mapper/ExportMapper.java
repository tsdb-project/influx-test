...
public interface ExportMapper {
     ...
     * @mbg.generated
     */
    @Insert({ "insert into export (query_id, ar, ", "layout, finished, canceled, ", "failed, machine, db_type, ", "db_version, create_time, ", "update_time, deleted, ", "patient_list, query_json)",
            "values (#{queryId,jdbcType=INTEGER}, #{ar,jdbcType=BIT}, ", "#{layout,jdbcType=BIT}, #{finished,jdbcType=BIT}, #{canceled,jdbcType=BIT}, ",
            "#{failed,jdbcType=BIT}, #{machine,jdbcType=VARCHAR}, #{dbType,jdbcType=VARCHAR}, ", "#{dbVersion,jdbcType=VARCHAR}, #{createTime,jdbcType=TIMESTAMP}, ",
            "#{updateTime,jdbcType=TIMESTAMP}, #{deleted,jdbcType=BIT}, ", "#{patientList,jdbcType=LONGVARCHAR}, #{queryJson,jdbcType=LONGVARCHAR})" })
    ...
    @Results({ @Result(column = "id", property = "id", jdbcType = JdbcType.INTEGER, id = true), @Result(column = "query_id", property = "queryId", jdbcType = JdbcType.INTEGER),
            @Result(column = "ar", property = "ar", jdbcType = JdbcType.BIT), @Result(column = "layout", property = "layout", jdbcType = JdbcType.BIT),
            @Result(column = "finished", property = "finished", jdbcType = JdbcType.BIT), @Result(column = "canceled", property = "canceled", jdbcType = JdbcType.BIT),
            @Result(column = "failed", property = "failed", jdbcType = JdbcType.BIT), @Result(column = "machine", property = "machine", jdbcType = JdbcType.VARCHAR),
            @Result(column = "db_type", property = "dbType", jdbcType = JdbcType.VARCHAR), @Result(column = "db_version", property = "dbVersion", jdbcType = JdbcType.VARCHAR),
            ...
            @Result(column = "deleted", property = "deleted", jdbcType = JdbcType.BIT), @Result(column = "patient_list", property = "patientList", jdbcType = JdbcType.LONGVARCHAR),
     ...
     * @mbg.generated
     */
    @Select({ "select", "id, query_id, ar, layout, finished, canceled, failed, machine, db_type, db_version, ", "create_time, update_time, deleted, patient_list, query_json", "from export",
     ...
     * @mbg.generated
     */
    @Update({ "update export", "set query_id = #{queryId,jdbcType=INTEGER},", "ar = #{ar,jdbcType=BIT},", "layout = #{layout,jdbcType=BIT},", "finished = #{finished,jdbcType=BIT},",
            "canceled = #{canceled,jdbcType=BIT},", "failed = #{failed,jdbcType=BIT},", "machine = #{machine,jdbcType=VARCHAR},", "db_type = #{dbType,jdbcType=VARCHAR},",
            "db_version = #{dbVersion,jdbcType=VARCHAR},", "create_time = #{createTime,jdbcType=TIMESTAMP},", "update_time = #{updateTime,jdbcType=TIMESTAMP},", "deleted = #{deleted,jdbcType=BIT},",
            "patient_list = #{patientList,jdbcType=LONGVARCHAR},", "query_json = #{queryJson,jdbcType=LONGVARCHAR}", "where id = #{id,jdbcType=INTEGER}" })
