...
public interface ExportMapper {
	...
	@Insert({ "insert into export (query_id, ar, ", "layout, finished, canceled, ", "failed, machine, db_type, ",
			...
			"all_patient, patient_list, ", "query_json)", "values (#{queryId,jdbcType=INTEGER}, #{ar,jdbcType=BIT}, ",
			...
			"#{allPatient,jdbcType=INTEGER}, #{patientList,jdbcType=LONGVARCHAR}, ",
	...
	@Select({ "select", "id, query_id, ar, layout, finished, canceled, failed, machine, db_type, db_version, ",
			"create_time, update_time, deleted, medical, username, finished_patient, all_patient, ",
	...
	@Update({ "update export", "set query_id = #{queryId,jdbcType=INTEGER},", "ar = #{ar,jdbcType=BIT},",
			...
			"medical = #{medical,jdbcType=BIT},", "username = #{username,jdbcType=VARCHAR},",
			"finished_patient = #{finishedPatient,jdbcType=INTEGER},", "all_patient = #{allPatient,jdbcType=INTEGER},",
