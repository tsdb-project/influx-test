...
public interface ExportMapper {
     ...
     * @mbg.generated
     */
    @Insert({ "insert into export (query_id, ar, ", "layout, finished, machine, ", "db_version, create_time, ", "update_time, patient_list, ",
            "query_json)", "values (#{queryId,jdbcType=INTEGER}, #{ar,jdbcType=BIT}, ",
            "#{layout,jdbcType=BIT}, #{finished,jdbcType=BIT}, #{machine,jdbcType=VARCHAR}, ",
            "#{dbVersion,jdbcType=VARCHAR}, #{createTime,jdbcType=TIMESTAMP}, ",
            "#{updateTime,jdbcType=TIMESTAMP}, #{patientList,jdbcType=LONGVARCHAR}, ", "#{queryJson,jdbcType=LONGVARCHAR})" })
     ...
     * @mbg.generated
     */
    @Select({ "select", "id, query_id, ar, layout, finished, machine, db_version, create_time, update_time, ", "patient_list, query_json",
            "from export", "where id = #{id,jdbcType=INTEGER}" })
    @Results({ @Result(column = "id", property = "id", jdbcType = JdbcType.INTEGER, id = true),
            @Result(column = "query_id", property = "queryId", jdbcType = JdbcType.INTEGER),
            @Result(column = "ar", property = "ar", jdbcType = JdbcType.BIT),
            @Result(column = "layout", property = "layout", jdbcType = JdbcType.BIT),
    ...
    @Update({ "update export", "set query_id = #{queryId,jdbcType=INTEGER},", "ar = #{ar,jdbcType=BIT},", "layout = #{layout,jdbcType=BIT},",
            "finished = #{finished,jdbcType=BIT},", "machine = #{machine,jdbcType=VARCHAR},", "db_version = #{dbVersion,jdbcType=VARCHAR},",
