...
public interface CsvFileMapper {
     ...
     * @mbg.generated
     */
    @Insert({ "insert into csv_file (id, pid, ", "filename, path, ", "size, uuid, header_time, ", "start_time, end_time, ",
            "length, machine, ", "density, deleted, delete_time)", "values (#{id,jdbcType=INTEGER}, #{pid,jdbcType=VARCHAR}, ",
            "#{filename,jdbcType=VARCHAR}, #{path,jdbcType=VARCHAR}, ",
            "#{size,jdbcType=INTEGER}, #{uuid,jdbcType=CHAR}, #{headerTime,jdbcType=TIMESTAMP}, ",
            "#{startTime,jdbcType=TIMESTAMP}, #{endTime,jdbcType=TIMESTAMP}, ",
            "#{length,jdbcType=INTEGER}, #{machine,jdbcType=VARCHAR}, ",
            "#{density,jdbcType=DOUBLE}, #{deleted,jdbcType=BIT}, #{deleteTime,jdbcType=TIMESTAMP})" })
     ...
     * @mbg.generated
     */
    @Select({ "select", "id, pid, filename, path, size, uuid, header_time, start_time, end_time, length, ",
            "machine, density, deleted, delete_time", "from csv_file", "where id = #{id,jdbcType=INTEGER}" })
    @Results({ @Result(column = "id", property = "id", jdbcType = JdbcType.INTEGER, id = true),
            @Result(column = "pid", property = "pid", jdbcType = JdbcType.VARCHAR),
            @Result(column = "filename", property = "filename", jdbcType = JdbcType.VARCHAR),
            @Result(column = "path", property = "path", jdbcType = JdbcType.VARCHAR),
    ...
    @Update({ "update csv_file", "set pid = #{pid,jdbcType=VARCHAR},", "filename = #{filename,jdbcType=VARCHAR},",
            "path = #{path,jdbcType=VARCHAR},", "size = #{size,jdbcType=INTEGER},", "uuid = #{uuid,jdbcType=CHAR},",
            "header_time = #{headerTime,jdbcType=TIMESTAMP},", "start_time = #{startTime,jdbcType=TIMESTAMP},",
            "end_time = #{endTime,jdbcType=TIMESTAMP},", "length = #{length,jdbcType=INTEGER},",
            "machine = #{machine,jdbcType=VARCHAR},", "density = #{density,jdbcType=DOUBLE},",
