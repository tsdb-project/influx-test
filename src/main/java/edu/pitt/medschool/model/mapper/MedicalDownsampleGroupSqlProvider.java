...
import edu.pitt.medschool.model.dto.MedicalDownsampleGroupExample.Criteria;
import edu.pitt.medschool.model.dto.MedicalDownsampleGroupExample.Criterion;
import edu.pitt.medschool.model.dto.MedicalDownsampleGroupExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class MedicalDownsampleGroupSqlProvider {

	/**
	 * This method was generated by MyBatis Generator. This method corresponds to the database table medical_downsample_group
	 * @mbg.generated
	 */
	public String countByExample(MedicalDownsampleGroupExample example) {
		SQL sql = new SQL();
		sql.SELECT("count(*)").FROM("medical_downsample_group");
	 ...
	 * @mbg.generated
	 */
	public String deleteByExample(MedicalDownsampleGroupExample example) {
		SQL sql = new SQL();
		sql.DELETE_FROM("medical_downsample_group");
		applyWhere(sql, example, false);
		return sql.toString();
	}
	 ...
	 * @mbg.generated
	 */
	public String insertSelective(MedicalDownsampleGroup record) {
		SQL sql = new SQL();
		sql.INSERT_INTO("medical_downsample_group");
	 ...
	 * @mbg.generated
	 */
	public String selectByExampleWithBLOBs(MedicalDownsampleGroupExample example) {
		SQL sql = new SQL();
		...
		sql.SELECT("deleted");
		sql.SELECT("columns");
		sql.FROM("medical_downsample_group");
		applyWhere(sql, example, false);
	 ...
	 * @mbg.generated
	 */
	public String selectByExample(MedicalDownsampleGroupExample example) {
		SQL sql = new SQL();
		if (example != null && example.isDistinct()) {
			sql.SELECT_DISTINCT("id");
		} else {
	...
	public String updateByExampleSelective(Map<String, Object> parameter) {
		MedicalDownsampleGroup record = (MedicalDownsampleGroup) parameter.get("record");
		MedicalDownsampleGroupExample example = (MedicalDownsampleGroupExample) parameter.get("example");
		SQL sql = new SQL();
		sql.UPDATE("medical_downsample_group");
	 ...
	 * @mbg.generated
	 */
	public String updateByPrimaryKeySelective(MedicalDownsampleGroup record) {
		SQL sql = new SQL();
		sql.UPDATE("medical_downsample_group");
		if (record.getQueryId() != null) {
	 ...
	 * @mbg.generated
	 */
	protected void applyWhere(SQL sql, MedicalDownsampleGroupExample example, boolean includeExamplePhrase) {
		if (example == null) {
			return;
		}
		String parmPhrase1;
