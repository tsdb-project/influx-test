...
public interface FeatureMapper {
    ...
    @Insert({ "insert into feature (id, SID, ", "SID_Count, type, ", "electrode, freq_low, ", "freq_high, brain_location, ", "notes)",
            ...
            "#{electrode,jdbcType=VARCHAR}, #{freqLow,jdbcType=DOUBLE}, ", "#{freqHigh,jdbcType=DOUBLE}, #{brainLocation,jdbcType=VARCHAR}, ", "#{notes,jdbcType=VARCHAR})" })
    ...
    @Results({ @Result(column = "id", property = "id", jdbcType = JdbcType.INTEGER, id = true), @Result(column = "SID", property = "sid", jdbcType = JdbcType.VARCHAR, id = true),
            @Result(column = "SID_Count", property = "sidCount", jdbcType = JdbcType.INTEGER, id = true), @Result(column = "type", property = "type", jdbcType = JdbcType.VARCHAR),
            @Result(column = "electrode", property = "electrode", jdbcType = JdbcType.VARCHAR), @Result(column = "freq_low", property = "freqLow", jdbcType = JdbcType.DOUBLE),
     ...
     * @mbg.generated
     */
    @Select({ "select", "id, SID, SID_Count, type, electrode, freq_low, freq_high, brain_location, notes", "from feature", "where id = #{id,jdbcType=INTEGER}",
     ...
     * @mbg.generated
     */
    @Update({ "update feature", "set type = #{type,jdbcType=VARCHAR},", "electrode = #{electrode,jdbcType=VARCHAR},", "freq_low = #{freqLow,jdbcType=DOUBLE},",
            "freq_high = #{freqHigh,jdbcType=DOUBLE},", "brain_location = #{brainLocation,jdbcType=VARCHAR},", "notes = #{notes,jdbcType=VARCHAR}",
