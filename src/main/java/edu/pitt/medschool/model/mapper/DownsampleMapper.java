...
public interface DownsampleMapper {
     ...
     * @mbg.generated
     */
    @Insert({ "insert into downsample (alias, period, ", "duration, origin, ", "create_time, update_time)", "values (#{alias,jdbcType=VARCHAR}, #{period,jdbcType=INTEGER}, ", "#{duration,jdbcType=INTEGER}, #{origin,jdbcType=INTEGER}, ", "#{createTime,jdbcType=TIMESTAMP}, #{updateTime,jdbcType=TIMESTAMP})" })
