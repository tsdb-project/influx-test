...
public interface DownsampleMapper {
     ...
     * @mbg.generated
     */
    @Insert({ "insert into downsample (alias, period, ", "duration, origin, ", "min_total_bin_threshold, min_every_bin_thershold, ", "needAr, is_downsample_first, ", "update_time, create_time, ",
            "patientList)", "values (#{alias,jdbcType=VARCHAR}, #{period,jdbcType=INTEGER}, ", "#{duration,jdbcType=INTEGER}, #{origin,jdbcType=INTEGER}, ",
            "#{minTotalBinThreshold,jdbcType=INTEGER}, #{minEveryBinThershold,jdbcType=INTEGER}, ", "#{needar,jdbcType=BIT}, #{isDownsampleFirst,jdbcType=BIT}, ",
            "#{updateTime,jdbcType=TIMESTAMP}, #{createTime,jdbcType=TIMESTAMP}, ", "#{patientlist,jdbcType=LONGVARCHAR})" })
    ...
    @Results({ @Result(column = "id", property = "id", jdbcType = JdbcType.INTEGER, id = true), @Result(column = "alias", property = "alias", jdbcType = JdbcType.VARCHAR),
            ...
            @Result(column = "min_every_bin_thershold", property = "minEveryBinThershold", jdbcType = JdbcType.INTEGER), @Result(column = "needAr", property = "needar", jdbcType = JdbcType.BIT),
     ...
     * @mbg.generated
     */
    @Select({ "select", "id, alias, period, duration, origin, min_total_bin_threshold, min_every_bin_thershold, ", "needAr, is_downsample_first, update_time, create_time, patientList",
    ...
    @Update({ "update downsample", "set alias = #{alias,jdbcType=VARCHAR},", "period = #{period,jdbcType=INTEGER},", "duration = #{duration,jdbcType=INTEGER},", "origin = #{origin,jdbcType=INTEGER},",
            "min_total_bin_threshold = #{minTotalBinThreshold,jdbcType=INTEGER},", "min_every_bin_thershold = #{minEveryBinThershold,jdbcType=INTEGER},", "needAr = #{needar,jdbcType=BIT},",
