...
public interface DownsampleMapper {
     ...
     * @mbg.generated
     */
    @Insert({ "insert into downsample (alias, period, ", "duration, origin, ", "create_time, update_time)", "values (#{alias,jdbcType=VARCHAR}, #{period,jdbcType=INTEGER}, ",
            "#{duration,jdbcType=INTEGER}, #{origin,jdbcType=INTEGER}, ", "#{createTime,jdbcType=TIMESTAMP}, #{updateTime,jdbcType=TIMESTAMP})" })
    ...
    @Results({ @Result(column = "id", property = "id", jdbcType = JdbcType.INTEGER, id = true), @Result(column = "alias", property = "alias", jdbcType = JdbcType.VARCHAR),
            ...
            @Result(column = "origin", property = "origin", jdbcType = JdbcType.INTEGER), @Result(column = "create_time", property = "createTime", jdbcType = JdbcType.TIMESTAMP),
     ...
     * @mbg.generated
     */
    @Update({ "update downsample", "set alias = #{alias,jdbcType=VARCHAR},", "period = #{period,jdbcType=INTEGER},", "duration = #{duration,jdbcType=INTEGER},",
            "origin = #{origin,jdbcType=INTEGER},", "create_time = #{createTime,jdbcType=TIMESTAMP},", "update_time = #{updateTime,jdbcType=TIMESTAMP}",
