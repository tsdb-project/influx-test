...
public interface DownsampleMapper {
     ...
     * @mbg.generated
     */
    @Insert({ "insert into downsample (alias, period, ", "duration, origin, ", "create_time, update_time)",
    ...
    @Update({ "update downsample", "set alias = #{alias,jdbcType=VARCHAR},", "period = #{period,jdbcType=INTEGER},",
            "duration = #{duration,jdbcType=INTEGER},", "origin = #{origin,jdbcType=INTEGER},", "create_time = #{createTime,jdbcType=TIMESTAMP},",
