...
public interface DownsampleMapper {
     ...
     * @mbg.generated
     */
    @Insert({ "insert into downsample (alias, period, ", "duration, origin, ", "min_bin, min_bin_row, ", "downsample_first, update_time, ",
            "create_time)", "values (#{alias,jdbcType=VARCHAR}, #{period,jdbcType=INTEGER}, ",
            "#{duration,jdbcType=INTEGER}, #{origin,jdbcType=INTEGER}, ", "#{minBin,jdbcType=INTEGER}, #{minBinRow,jdbcType=INTEGER}, ",
            "#{downsampleFirst,jdbcType=BIT}, #{updateTime,jdbcType=TIMESTAMP}, ", "#{createTime,jdbcType=TIMESTAMP})" })
     ...
     * @mbg.generated
     */
    @Select({ "select", "id, alias, period, duration, origin, min_bin, min_bin_row, downsample_first, ", "update_time, create_time",
