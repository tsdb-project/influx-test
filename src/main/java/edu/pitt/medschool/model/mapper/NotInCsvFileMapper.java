...
public interface NotInCsvFileMapper {
     ...
     */
    @Insert({
        "insert into not_in_csv_file (id, pid, ",
        "start_time, end_time, ",
        "header_time, uuid, ",
        "filename, length, ",
        "density, comment, ",
        "last_update, not_in_csv_filecol, ",
        "machine, ar, path, ",
        "size, conflict_resolved, ",
        "status, width)",
    ...
    @Select({
        ...
        "comment, last_update, not_in_csv_filecol, machine, ar, path, size, conflict_resolved, ",
        "status, width",
        "from not_in_csv_file",
        "where id = #{id,jdbcType=INTEGER}"
    })
    @Results({
        @Result(column="id", property="id", jdbcType=JdbcType.INTEGER, id=true),
    ...
    @Update({
        ...
        "set pid = #{pid,jdbcType=VARCHAR},",
          ...
          "not_in_csv_filecol = #{notInCsvFilecol,jdbcType=VARCHAR},",
