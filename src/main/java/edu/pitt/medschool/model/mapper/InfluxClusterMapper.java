...
public interface InfluxClusterMapper {
     ...
     */
    @Insert({
        "insert into influx_cluster (id, cluster_id, ",
        "machine_id, ip_addr)",
        "values (#{id,jdbcType=INTEGER}, #{clusterId,jdbcType=VARCHAR}, ",
        "#{machineId,jdbcType=VARCHAR}, #{ipAddr,jdbcType=VARCHAR})"
    })
    ...
    @Results({
        ...
        @Result(column="machine_id", property="machineId", jdbcType=JdbcType.VARCHAR),
    ...
    @Select({
        "select",
        "id, cluster_id, machine_id, ip_addr",
        "from influx_cluster",
        "where id = #{id,jdbcType=INTEGER}"
    })
    @Results({
