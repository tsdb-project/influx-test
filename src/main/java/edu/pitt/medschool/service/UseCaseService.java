...
public class UseCaseService {
    ...
    private InfluxDB influxDB = InfluxDBFactory.connect(InfluxappConfig.IFX_ADDR, InfluxappConfig.IFX_USERNAME, InfluxappConfig.IFX_PASSWD,
            new OkHttpClient.Builder().connectTimeout(60, TimeUnit.SECONDS).readTimeout(1200, TimeUnit.SECONDS).writeTimeout(120, TimeUnit.SECONDS));
    ...
    public String useCaseTwo() throws IOException {
        ...
        String[] cols = new String[] { "ID", "Data Status", "aEEG1", "aEEG2", "aEEG3", "aEEG4", "aEEG5", "aEEG6", "aEEG7", "aEEG8", "aEEG9", "aEEG10",
                "aEEG11", "aEEG12", "aEEG13", "aEEG14", "aEEG15", "aEEG16", "aEEG17", "aEEG18", "aEEG19", "aEEG20", "aEEG21", "aEEG22", "aEEG23",
                "aEEG24", "aEEG25", "aEEG26", "aEEG27", "aEEG28", "aEEG29", "aEEG30", "aEEG31", "aEEG32", "aEEG33", "aEEG34", "aEEG35", "aEEG36",
                "aEEG37", "aEEG38", "aEEG39", "aEEG40", "aEEG41", "aEEG42", "aEEG43", "aEEG44", "aEEG45", "aEEG46", "aEEG47", "aEEG48" };
        ...
        Runnable queryTask = () -> {
            ...
            while ((patientId = idQueue.poll()) != null) {
                try {
                    ...
                    String queryString = String.format(template, patientId, firstRecordTime, firstRecordTime, firstRecordTime, firstRecordTime,
                            offset);

                    String countQueryString = String.format(countTemplate, patientId, firstRecordTime, firstRecordTime, firstRecordTime,
