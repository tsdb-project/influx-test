...
public class DataDeletionTest {
    ...
    public static void checkPatientFiles(String pid) {
        String queryStringLong = String.format(
                "SELECT \"I123_1\" FROM \"%s\" GROUP BY * LIMIT 1;SELECT \"I123_1\" FROM \"%s\" GROUP BY * ORDER BY time DESC LIMIT 1;",
                pid, pid);
        ...
        Query query = new Query(queryStringLong, "data");
